...
#else
                // Matt: When not using HoloLens, need to position the marks somehow
                legendValueInstance.transform.localPosition =
                    new Vector3(0, -0.03f * channelEncoding.scale.domain.IndexOf(domainValue), 0);
#endif
            }
